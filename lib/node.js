...
export class Node {
  constructor() {
    ...
    this.customsModules = ['permissions', 'messages', 'incoming', 'swarm']
  }
  ...
  async execute(mod, func, pay, from) {
    var isAuth = true
    ...
    if (from) {
      ...
      isAuth = await this.permissions.check(from, permissions)
    }
